...
ssh -t -A PB@timbernhardt.synology.me bash -c "rsync -e \"ssh -t -p 6543\" -r --links --exclude-from=.rsyncignore --delete . germansc@germanschool.co.ke:/home/germansc/charity.germanschool.co.ke"
